...
$(OUTNAME).elf: $(OBJ)
	@mkdir -p $(OUTPUT_PATH)
	@echo Linking $@
	@$(LINK) -d -o $@ --elf --ro 0x42000000 --first txm_module_preamble.S.o --entry=_txm_module_thread_shell_entry --map --remove --symbols --list $(OUTNAME).map $^ $(SELF_DIR)common/bin/lib.a
