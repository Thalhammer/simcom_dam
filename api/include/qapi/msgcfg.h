...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/1.0.c3/api/services/msgcfg.h#1 $
...
/*SIMCOM Jumping fix “∆÷≤  ≈‰≤„ at 17-02-13 begin*/
#ifdef __SIMCOM_MSG_SSID__
#define MSG_SSID_SIMCOM      MSG_FIRST_TARGET_OEM_SSID
#define MSG_SSID_SIMCOM_PUB  (MSG_SSID_SIMCOM+1)
#define MSG_SSID_SIMCOM_DEMO (MSG_SSID_SIMCOM+2)
#endif
/*SIMCOM Jumping fix “∆÷≤  ≈‰≤„ at 17-02-13 end*/
...
#endif  /*SIMCOM Jumping fix “∆÷≤  ≈‰≤„ at 17-02-13 add*/
