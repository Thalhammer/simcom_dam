...
#ifndef _QAPI_ALI_IOT_MQTT_H_
#define _QAPI_ALI_IOT_MQTT_H_
 ...
 */
#define IOT_MQTT_Construct(pInitParams)\
    ((void *) (_txm_module_system_call12)(TXM_QAPI_IOT_MQTT_CONSTRUCT,\
    (ULONG) pInitParams,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
 ...
 */
#define IOT_MQTT_Destroy(phandle)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_MQTT_DESTROY,\
    (ULONG) phandle,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))
 ...
 * @return status.
 */
#define IOT_MQTT_Yield(handle, timeout_ms)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_MQTT_YIELD,\
    (ULONG) handle,(ULONG) timeout_ms, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))
 ...
 */
#define IOT_MQTT_CheckStateNormal(handle)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_MQTT_CHECK_STATE_NORMAL,\
 ...
 * @verbatim
   ...
   @endverbatim
 */
#define IOT_MQTT_Subscribe(handle, topic_filter, qos, topic_handle_func, pcontext)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_MQTT_SUBSCRIBE,\
    (ULONG) handle,(ULONG) topic_filter, (ULONG) qos, (ULONG) topic_handle_func,(ULONG) pcontext,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))
 ...
 * @verbatim
   ...
   @endverbatim
 */
#define IOT_MQTT_Unsubscribe(handle, topic_filter)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_MQTT_UNSUBSCRIBE,\
    (ULONG) handle,(ULONG) topic_filter, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))
