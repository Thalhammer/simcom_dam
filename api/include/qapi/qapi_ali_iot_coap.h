...
#ifndef __QAPI_ALI_IOT_COAP_H__
#define __QAPI_ALI_IOT_COAP_H__
...
#define IOT_CoAP_Init(p_config)\
    ((iotx_coap_context_t *) (_txm_module_system_call12)(TXM_QAPI_IOT_COAP_INIT,\
    (ULONG) p_config,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))

#define IOT_CoAP_Deinit(p_context)\
    ( (_txm_module_system_call12)(TXM_QAPI_IOT_COAP_DEINIT,\
    (ULONG) p_context,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))

#define IOT_CoAP_DeviceNameAuth(p_context)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_COAP_DEVICE_NAME_AUTH,\
    (ULONG) p_context,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))

#define IOT_CoAP_Yield(p_context)\
    ((int) (_txm_module_system_call12)(TXM_QAPI_IOT_COAP_YIELD,\
    (ULONG) p_context,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))
